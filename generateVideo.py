...
for images_folder in listdir(f'{path}/Images'):
    ...
    try:
        run(['/home/sr1/videoAUTO/scripts/videoOutput.sh', f'"{images_folder}"', f'{image_duration}', f'{path}/Images/{images_folder}'])
...
videos_list = []
num = 1
transition_clip = VideoFileClip('/home/sr1/videoAUTO/scripts/transition.mp4')
for videos in listdir('..'):
    if videos.endswith('.mp4'):
        ...
        isf_logo = ImageClip('/home/sr1/videoAUTO/scripts/isf.png').set_duration(video_duration)
...
intro_clip = VideoFileClip(f'/home/sr1/videoAUTO/scripts/introISF.mp4').set_pos('center')
subscribe_clip = VideoFileClip(f'/home/sr1/videoAUTO/scripts/subs.mp4', audio=False).set_pos('center')
